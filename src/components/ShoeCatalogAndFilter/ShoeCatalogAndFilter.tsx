...
import styles from "./ShoeCatalogAndFilter.module.scss";
import Image from "next/image";
import Link from "next/link";
import { Shoe } from "../../../public/types";

type ShoeCatalogAndFilterProps = {
  shoes: Shoe[];
};

const ShoeCatalogAndFilter = ({ shoes = [] }: ShoeCatalogAndFilterProps) => {
...
export default ShoeCatalogAndFilter;
